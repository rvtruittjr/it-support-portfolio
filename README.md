...
[![Active Directory](https://img.shields.io/badge/AD-Lab%2050%20Users-orange)](lab-screenshots/)

## 📋 **30-Day Training Progress**

| Week | Skills Mastered | Tickets Completed | Job Applications |
|------|------------------|-------------------|------------------|
| 1️⃣ Week 1 | IT Fundamentals, Ticketing Workflow | **5** | **2** |
| 2️⃣ Week 2 | Active Directory Setup, User Management | **8** | **4** |
| 3️⃣ Week 3 | PowerShell Automation, Group Policy | **10** | **6** |
| 4️⃣ Week 4 | Troubleshooting, Resume Prep, Networking | **12** | **8** |
